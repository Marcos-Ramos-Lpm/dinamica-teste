...
<html lang="pt-BR">
    ...
    <body class="fix-header fix-sidebar logo-center card-no-border">
            ...
            <div class="page-wrapper">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">HISTÓRICO DE USUÁRIOS</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo Url::getBase() ?>home">Home</a></li>
                            <li class="breadcrumb-item active">Histórico de Usuários</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="tabela-historico" class="table w-100 table-hover table-bordered table-striped" >
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>NOME</th>
        ...
        <script src="<?php echo Url::getBase() ?>modulo/usuario/js/historico-usuarios.js" type="text/javascript"></script>
    </body>
